alert('Bạn hãy nhập những thông tin sau đây: ');
let nguoiNhan = prompt('Tên người nhận: ');
let diaDiem = prompt('Địa điểm: ');
let thoiGian = prompt('Thời gian: (Nhập theo dạng sau: Ngày dd tháng mm năm yyyy)');
document.write('"' + nguoiNhan + ' thương nhớ,');
document.write('<br>');
document.write('<br>');
